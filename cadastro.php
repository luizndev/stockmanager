        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if ($insertStmt) {
                ...
                echo $html;
                    ...
                    // echo "var html = `<div id='notifications'><div id='sucesso'><span class='material-symbols-outlined'>done_all</span>Item Cadastrado com Sucesso!</div></div>`;$(html).fadeIn(2000).appendTo('#notifications').delay(event.data.time).fadeOut(2000);"
                    // echo "<div class='stock-notify'><div class='notify-container'><div class='notify-top'><img src='images/check-gif.gif'><h1>Item cadastrado com sucesso!</h1></div><div id='notify-bottom' class='notify-bottom'>Fechar</div></div></div><script>var playaudio = 1;</script";
                } else {
